...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._retrieveUserProfile(accessToken, function (err, body, res) {
    ...
    var gotUserProfile = true;
    if (err) {
      // ERROR happens if using Dropbox Business API key, as this method isn't allowed
      // return done(new InternalOAuthError('failed to fetch user profile', err));

      // TODO Call /members/list, find member profile with team_admin role
